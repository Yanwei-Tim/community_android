...
public class CaptureActivity extends Activity implements Callback
{
	...
	private void setScanWidthHeight(){
		...
		if(width<=0)
			width=320;
		CameraManager.MIN_FRAME_WIDTH = (width*3/5);
		CameraManager.MIN_FRAME_HEIGHT = (width*3/5);
		CameraManager.MAX_FRAME_WIDTH = (width*3/5);
		CameraManager.MAX_FRAME_HEIGHT = (width*3/5);
	...
	public void handleDecode(final Result obj, Bitmap barcode)
	{
		...
		if (resultString.equals("")||resultString==null) {
			Toast.makeText(CaptureActivity.this, "读取二维码出错!", Toast.LENGTH_SHORT).show();
		}else {
