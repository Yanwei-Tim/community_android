...
public class DoorplateAdapter extends BaseAdapter {
    ...
    public DoorplateAdapter(Context context, List<Object> objectList, List<String> listTag) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        final Object object = objectList.get(position);
            if (object instanceof String && listTag.contains(getItem(position))) {
                ...
                if("房东信息:".equals(ss)){
                    convertView = inflater.inflate(R.layout.group_list_lardlord_item_tag, null);
                    TextView tagText_tv = (TextView)convertView.findViewById(R.id.tag_text);
                    tagText_tv.setText(ss);
                }else if("租客信息:".equals(ss)) {
                    convertView = inflater.inflate(R.layout.group_list_item_tag, null);
                    TextView tagText_tv = (TextView)convertView.findViewById(R.id.tag_text);
                    tagText_tv.setText(ss);
                }
            } else {
                if (object instanceof LardLord) {
                    final LardLord entity = (LardLord) object;
                    convertView = inflater.inflate(R.layout.listview_item_info, null);
                    ...
                    info_bt.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View view) {
                            Intent i = new Intent(context, LardLordInfoActivity.class);
                            i.putExtra("lardLord", entity);
