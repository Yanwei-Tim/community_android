...
import com.otg.community.utils.IpEditer;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button_ok.setOnClickListener(new OnClickListener() {
            public void onClick(View v) {
                ...
                //重新配置
                SharedPreferences mSharedPrefs = PreferenceManager.getDefaultSharedPreferences(SetAdminActivity.this);
                SharedPreferences.Editor editor = mSharedPrefs.edit();
                editor.putString("remote_admin_ip", remoteIP);
                editor.putString("remote_admin_port", remotePort);
                editor.commit();
                finish();
            }
        });
